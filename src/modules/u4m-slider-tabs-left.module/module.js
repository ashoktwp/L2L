$(document).ready(function () {
  ...
  function changeTabIndex() {
    ...
    $('.ctvb-tabs ul li').eq(currnetIndex - 1).addClass('active');
  ...
  $('.ctvb-tabs ul a').on('click', function (e) {
    ...
    var tabIndex = tabContentObj.filter(`[id="${tabId.replace('#', '')}"]`).index(); // Find tab index by ID
    if (tabIndex !== -1) {
...
$(document).on("click", ".ctvb-tabcol.activetab .ctvb-playbtn", function(){ 
  ...
  $('.ctvb-tabcol.activetab .ctvb-tabplaceholder , .ctvb-tabcol.activetab .ctvb-btnicon , .ctvb-tabcol.activetab .ctvb-tabottom').addClass('hidetabdetail');
});
