$(document).ready(function () {
  ...
  function openAccordion(index) {
    ...
    $currentItem.children('.toggle_section').slideDown(250).parent().siblings().children('.toggle_section').slideUp(250);
    ...
    $currentItem.find('.progress-line').animate({ width: '100%' }, autoplayInterval);

    // Update the corresponding image
    $('.u4m-slider-tabs-left .slider-tabs-wrapper .left_col .img-items').each(function () {
